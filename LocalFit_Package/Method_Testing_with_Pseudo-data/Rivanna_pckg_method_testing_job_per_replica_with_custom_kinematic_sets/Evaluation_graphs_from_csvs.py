...
#Line below: Change to location where all the models are stored, need for csv files created for histograms
cff_predictions_dir = '/scratch/<your-computing-id>/DNN_CFFs_quick_test/Tests'

...
# Define the scratch path where the results will be saved, and the path where you call your models
scratch_path = '/scratch/qzf7nj/DNN_CFFs/LocalFit_BasicModel_Comparison_100_150/Sampled/'

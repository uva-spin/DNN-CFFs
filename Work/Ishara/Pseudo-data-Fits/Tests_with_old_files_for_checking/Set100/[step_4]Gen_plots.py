...
comparison_plots_folder = 'Comparison_Plots_Step3'
CFF_results_folder = 'CFF_Mean_Deviation_Plots'

create_folders(comparison_plots_folder)
create_folders(CFF_results_folder)
...
def generate_f_vs_phi_plot_from_csv(csv_path, output_dir=str(comparison_plots_folder)):
    """
...
def generate_mean_std_plots(df, cff_labels, output_dir=str(CFF_results_folder), sets_per_plot=20):
    """
...
def generate_plots_from_csv(csv_path, output_dir=str(comparison_plots_folder)):
    """
...
# Example usage
evaluation_csv = 'results.csv'
scratch_path = scratch_path
output_dir = str(comparison_plots_folder)

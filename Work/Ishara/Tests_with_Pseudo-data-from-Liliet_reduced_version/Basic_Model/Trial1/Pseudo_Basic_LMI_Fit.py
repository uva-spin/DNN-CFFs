...
data_file = 'pseudo_basic_BKM10_Jlab_all_t2.csv'
...
def DNNmodel():
    ...
    x3 = tf.keras.layers.Dense(100, activation="tanh", kernel_initializer=initializer)(x2)
    x4 = tf.keras.layers.Dense(100, activation="tanh", kernel_initializer=initializer)(x3)
    x5 = tf.keras.layers.Dense(100, activation="tanh", kernel_initializer=initializer)(x4)

...
def DNNmodel():
    ...
    x1 = tf.keras.layers.Dense(40, activation="relu6", kernel_initializer=initializer)(kinematics)
    x2 = tf.keras.layers.Dense(70, activation="relu6", kernel_initializer=initializer)(x1)
    x3 = tf.keras.layers.Dense(100, activation="relu6", kernel_initializer=initializer)(x2)
    x4 = tf.keras.layers.Dense(70, activation="relu6", kernel_initializer=initializer)(x3)
    x5 = tf.keras.layers.Dense(40, activation="relu6", kernel_initializer=initializer)(x4)

...
def DNNmodel(train_data=None, learning_rate=1e-2):
    ...
    x1 = tf.keras.layers.Dense(50, activation="relu", kernel_initializer=initializer)(kinematics)
    
    x2 = tf.keras.layers.Dense(40, activation="relu", kernel_initializer=initializer)(x1)
    
    x3 = tf.keras.layers.Dense(30, activation="relu", kernel_initializer=initializer)(x2)
    
    x4 = tf.keras.layers.Dense(20, activation="relu", kernel_initializer=initializer)(x3)
    
    outputs = tf.keras.layers.Dense(4, activation="linear", kernel_initializer=initializer,
                                    name='cff_output_layer')(x4)

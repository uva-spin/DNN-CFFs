...
def DNNmodel(train_data=None, learning_rate=1e-2):
    ...
    x1 = tf.keras.layers.Dense(60, activation="relu6", kernel_initializer=initializer)(kinematics)
    
    x2 = tf.keras.layers.Dense(50, activation="tanh", kernel_initializer=initializer)(x1)
    
    x3 = tf.keras.layers.Dense(40, activation="relu6", kernel_initializer=initializer)(x2)
